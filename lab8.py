...
def save_results(results):
    with open('results8.csv', 'w', newline='') as csvfile:
...
def main():
    ...
    if os.path.exists('results8.csv'):
        os.remove('results8.csv')
    ...
    pp_list = [0.01, 0.05]  # b prog aktywacji
